...
public class TextGizmo
{
	...
	public void DrawText(Vector3 position, object message) { DrawText(position, message != null ? message.ToString() : "(null)"); }

	public void DrawText(Vector3 position, string format, params object[] args) { DrawText(position, string.Format(format, args)); }
